...
import com.chat.swing.PanelSlider;
...
public class Login extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        slide = new com.chat.swing.PanelSlider();

        setBackground(new java.awt.Color(255, 255, 255));

        pic.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/chat/icon/login_image.png")));
        pic.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                picPropertyChange(evt);
            }
        });
        ...
        lbTitle.getAccessibleContext().setAccessibleName("z");
    ...
    private void picPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_picPropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_picPropertyChange
    ...
    private com.chat.swing.PanelSlider slide;
